...
- **Target pet guide:** a compact hint automatically appears above the bar for supported wild targets, showing family, useful family abilities, suggested role, level, and live rare/elite status. It covers 19 pet families and 21 named beasts. Hover the hint or its small badge for the full guide. Blue is a family hint, gold is a watch-list or special target, and red means above your level. This beta guide recommends family abilities; check Beast Lore for the individual beast’s tameability and actual skills.

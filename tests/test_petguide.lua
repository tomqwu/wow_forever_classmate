...
local heading,summary=NS.PetGuide.Summary(info)
check(heading=='Family: Wolf — Furious Howl' and summary:find('Above your level',1,true) and summary:find('Rare',1,true),'summary includes family ability and priority level/rarity warnings')

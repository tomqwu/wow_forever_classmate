...
function Host.Create(module,db,contentFactory)
    ...
    host:SetSize(module.width or NS.ClassBarWidth,height);host:SetFrameStrata('MEDIUM')
    ...
    Apply=function()
        ...
        host:SetShown(db.enabled);host:SetSize(module.width or NS.ClassBarWidth,height)

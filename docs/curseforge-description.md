...
[Pet guide data and sources](https://github.com/tomqwu/wow_forever_classmate/blob/main/docs/pet-guide-sources.md) · [Source code](https://github.com/tomqwu/wow_forever_classmate) · [Report an issue](https://github.com/tomqwu/wow_forever_classmate/issues)

...
The module discovers learned spells from the live spellbook instead of assuming Classic spell IDs. Unavailable or secret values remain blank. It never casts, targets, dismisses a totem, or changes a rotation automatically. Research and behavior notes are in [the Shaman module guide](https://github.com/tomqwu/wow_forever_classmate/blob/main/docs/shaman-module.md).
...
[Project copy](https://github.com/tomqwu/wow_forever_classmate/blob/main/docs/project-copy.md) · [Shaman research](https://github.com/tomqwu/wow_forever_classmate/blob/main/docs/shaman-module.md) · [Pet guide sources](https://github.com/tomqwu/wow_forever_classmate/blob/main/docs/pet-guide-sources.md) · [Developer guide](https://github.com/tomqwu/wow_forever_classmate/blob/main/docs/development.md) · [Release history](https://github.com/tomqwu/wow_forever_classmate/blob/main/docs/changelog.md)

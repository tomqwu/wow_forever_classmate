...
Active source: `addons/ForeverUtilities/`. The folder, TOC filename, saved-variable name, and release tag prefix remain stable for upgrades. Version 0.21.15 supports all nine classes through the registry in `Core.lua`.

...
Reviewed **2026-09-25** for the **Forever 1.60.1 beta**. This is an embedded,
...
Gold means a live rare/elite/boss classification.
...
`Hyena family guide` or `Name match The Rake | Cat guide`. It turns red above your level.
...
Owned pets, including friendly pets belonging to other players, get family advice. If their exact English name and live family match a rare record, they also get a clearly labeled possible rare-origin hint with source zone and wild level. This is not proof of origin or tameability; a renamed pet can share the same name.
...
"Family guide" is our role suggestion, not a measured DPS ranking. Any guide-listed
family skill in the tooltip is **not a claim that this creature already knows
or teaches it**. The selected individual's abilities are unknown. Spider Web was
removed after a player observed Forever spiders without it, including in ROL.
Skill ranks, innate abilities, unlock levels, spawn timers,
...
only an exact English name + family match produces a possible rare-origin hint. This can
suggest an unrenamed pet such as The Rake, but it cannot prove origin after
